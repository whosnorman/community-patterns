...
const inst: IFrameRecipe = /* IFRAME-V0 */ {
  ...
  "argumentSchema": {
    ...
    "title": "IFrame Demo: Catch the Square",
    "description":
      "Demo pattern showing iframe functionality - click the square to score points!",
  },
  "resultSchema": {
    "type": "object",
    "title": "IFrame Demo: Catch the Square",
    "description":
      "Demo pattern testing iframe click handling and reactive state",
    "properties": {
      "score": {
        "type": "integer",
        "title": "Score",
