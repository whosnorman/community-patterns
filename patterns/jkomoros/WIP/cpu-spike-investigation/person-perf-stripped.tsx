 ...
 * the `changesPreview` computed cell and modal rendering with `.map()`.
 *
 * This pattern adds ONLY the changesPreview logic to the minimal repro
 * to test if that's the root cause.
 *
 * EXPECTED:
 * - If ~60 seconds: changesPreview + modal is the cause
...
export default pattern(() => {
  ...
  return {
    [NAME]: "Person Perf Stripped",
    [UI]: (
      <div style={{ padding: "1rem", fontFamily: "monospace" }}>
        <h1>Person Perf Stripped</h1>
