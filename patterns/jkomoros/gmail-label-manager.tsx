 ...
 * - Dynamic tags based on granted scopes (e.g., #googleAuthGmailModify)
  ...
  async (
    ...
    try {
      ...
      const params: ModifyLabelsParams = {
        ...
        removeLabelIds:
          op.removeLabelIds.length > 0 ? op.removeLabelIds : undefined,
      };
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            cursor: "pointer",
                            border: "1px solid",
                            borderColor: derive(isSelected, (s) =>
                              s ? "#16a34a" : "#d1d5db",
                            ),
                            background: derive(isSelected, (s) =>
                              s ? "#dcfce7" : "white",
                            ),
                            color: derive(isSelected, (s) =>
                              s ? "#166534" : "#374151",
                            ),
                            opacity: derive(isInRemove, (r) => (r ? 0.5 : 1)),
                          }}
                        >
                          {label.type === "system" ? `[${label.name}]` : label.name}
                        </button>
                      );
                    }),
                  )}
