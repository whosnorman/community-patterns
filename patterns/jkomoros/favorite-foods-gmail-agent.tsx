...
Report each discovery immediately. Focus on patterns - if someone orders from the same place 3 times, that's a strong signal!`,
    ...
    return {
      ...
      [UI]: (
        <ct-screen>
          <div slot="header">
            <h2 style={{ margin: "0", fontSize: "18px" }}>My Food Preferences</h2>
          </div>
                ...
                {derive(groupedFoods, (groups) => {
                  ...
                  if (categories.length === 0) {
                    return (
                      ...
                      >
                        No food preferences found yet. Click "Discover" to search your
                        emails.
                      </div>
                    );
                  }
                  ...
                  return categories.map((category) => (
                    ...
                    >
                      ...
                      >
                        {categoryLabels[category] || category} ({groups[category].length})
                      </summary>
                        ...
                        {groups[category].map((f: FoodPreference) => (
                          ...
                          >
                            ...
                            <div
                              style={{
                                fontSize: "12px",
                                color: f.confidence >= 80 ? "#059669" : f.confidence >= 50 ? "#d97706" : "#6b7280",
                                fontWeight: "600",
                              }}
                            >
                              {f.confidence}%
